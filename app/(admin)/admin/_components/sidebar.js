        ...
        {routes.map((route) => {
          ...
          return (
            <Link
              ...
              href={route.href}
              className={cn(
                "flex items-center gap-x-2 text-slate-500 text-sm font-medium pl-6 py-3 transition-all hover:text-slate-600 hover:bg-slate-100/50",
                isActive && "text-slate-700 bg-slate-100 h-12",
                pathname === route.href
